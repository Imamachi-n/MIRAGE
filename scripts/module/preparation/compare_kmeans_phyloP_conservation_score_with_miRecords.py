...
ref_file = open('../../../result/phyloP46way_miRBase_v21_hg38Tohg19_kmeans6_2015-07-20.txt','r')
input_file = open('../../../data/mirMark/S1_site-level_human_miRNA-target_site_pairs_from_miRecords_id-seq.txt','r')
output_file = open('../../../result/phyloP46way_miRBase_v21_hg38Tohg19_with_miRecords_kmeans6_2015-07-20.txt','w')
...
print('6: ',ref_counter['6'],int(ref_counter['6'])/total*100)
...
print('1: ',kmeans_count['1'],int(kmeans_count['1'])/130*100)
print('2: ',kmeans_count['2'],int(kmeans_count['2'])/130*100)
print('3: ',kmeans_count['3'],int(kmeans_count['3'])/130*100)
print('4: ',kmeans_count['4'],int(kmeans_count['4'])/130*100)
print('5: ',kmeans_count['5'],int(kmeans_count['5'])/130*100)
print('6: ',kmeans_count['6'],int(kmeans_count['6'])/130*100)
