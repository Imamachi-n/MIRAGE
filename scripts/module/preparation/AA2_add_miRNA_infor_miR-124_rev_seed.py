...
input_file = open('../../../result/mirage_output_rev_seed_miR-124_vs_RefSeq_NM_2015-07-30.txt','r')
output_file = open('../../../result/mirage_output_rev_seed_miR-124_vs_RefSeq_NM_2015-07-30_miR-124_overexpression.result','w')
