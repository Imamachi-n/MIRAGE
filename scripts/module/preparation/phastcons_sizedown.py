...
def main():
    ...
    #for x in ['chrY']:
        ...
        input_s = p.phastcons_sizedown_score_input + x + '.phastCons46way.bed'
        output_s = p.phastcons_sizedown_score_output +  x + '.phastCons46way_Refseq_CDS.db' #phastCons46way_miRBase_v21_hg38Tohg19.db
        phastcons_sizedown_input_file = open(input_s,'r')
        ...
        for line in phastcons_sizedown_input_file:
            line = line.rstrip()
            data = line.split("\t")
            st_site = 0
            score = 0
        ...
        utils.now_time("phastcons_sizedown script was successfully finished!!")
        phastcons_sizedown_input_file.close()
        shelve_db.close()
